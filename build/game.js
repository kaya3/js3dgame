...
var Util = /** @class */ (function () {
    ...
    Util.jitter = function (val, d) {
        var delta = (Math.random() - 0.5) * d;
        return val + delta;
    };
...
var PointLight = /** @class */ (function () {
    function PointLight(pos, color, initialIntensity, status, kind) {
        this.pos = pos;
        this.color = color;
    ...
    PointLight.prototype.updateIntensity = function (dt) {
        if (this.status === 'off') {
            this.intensity = 0;
        }
            ...
            var d = this.initialIntensity * this.flickerJitterPercentage;
...
var SCENE_DATA = (function () {
    ...
    return {
        faces: [
            ...
            { label: "I (anti-clockwise NW-facing wall)", isWalkable: false, texture: "wall", coords: [v(2, 15, Z_GROUND), v(2, 15, Z_PLAT2), v(-4, 15, Z_PLAT2), v(-4, 15, Z_GROUND)] },
            { label: "M (anti-clockwise NW-facing wall)", isWalkable: false, texture: "wall", coords: [v(6, 15, Z_GROUND), v(6, 15, Z_PLAT2), v(4, 15, Z_PLAT2), v(4, 15, Z_GROUND)] },
            { label: "K", isWalkable: false, texture: "wall", coords: [v(-4, 23, Z_GROUND), v(-4, 23, Z_PLAT2), v(6, 23, Z_PLAT2), v(6, 23, Z_GROUND)] },
            { label: "L (anti-clockwise NE-facing wall)", isWalkable: false, texture: "wall", coords: [v(6, 23, Z_GROUND), v(6, 23, Z_PLAT2), v(6, 15, Z_PLAT2), v(6, 15, Z_GROUND)] },
...
var Game = /** @class */ (function () {
    function Game(scene) {
        ...
        var light = this.playerLight = new PointLight(Vector3.ZERO, Color.rgb(255, 255, 200), 1, 'flickering', 'dynamic');
